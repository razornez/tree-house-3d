...
uniform sampler2D uDayTexture6;
uniform sampler2D uNightTexture6;
...
void main() {
    ...
    } else if(uTextureSet == 5) {
        dayColor = texture2D(uDayTexture5, vUv).rgb;
        nightColor = texture2D(uNightTexture5, vUv).rgb;
    } else {
        dayColor = texture2D(uDayTexture6, vUv).rgb;
        nightColor = texture2D(uNightTexture6, vUv).rgb;
    }
